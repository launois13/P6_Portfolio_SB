...
async function fetchWorks() {
  ...
  function generateCategoryMenu(categories, fetchedWorks) {
    ...
    categories.forEach(category => {
      ...
      categoryButton.addEventListener('click', async () => {
        filterWorksByCategory(category.id, fetchedWorks);
        removeActivatedClass();
    ...
    fetchWorks()
      .then(fetchedWorks => {
        ...
        fetchCategories().then(fetchedCategories=>{
          ...
          if(token === null){
            generateCategoryMenu(fetchedCategories, fetchedWorks);
          }
        })
